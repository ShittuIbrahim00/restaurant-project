...
const ChefDetail = () => {
  ...
  const chefs = [
    ...
    {
      id: 5,
      img: "https://html.awaikenthemes.com/spicyhunt/images/team-5.jpg",
      name: "Oliver Bennett",
      position: "Executive Chef",
      speciality: "Chef",
      experience: 12,
    ...
    {
      id: 7,
      img: "https://html.awaikenthemes.com/spicyhunt/images/team-7.jpg",
      name: "James Anderson",
    ...
    {
      id: 6,
      img: "https://html.awaikenthemes.com/spicyhunt/images/team-6.jpg",
      name: "Ava Martinez",
    ...
    {
      id: 8,
      img: "https://html.awaikenthemes.com/spicyhunt/images/team-8.jpg",
      name: "Liam Robinson",
    ...
    <div className="bg-black w-full opacity-95 pb-14">
      <div className="relative">
        <div
          ...
          style={{
            backgroundImage: `url('https://html.awaikenthemes.com/spicyhunt/images/page-header-bg.jpg')`,
          }}
        ></div>
      ...
      <div className="lg:pt-[620px] pt-[550px] mx-4 lg:flex items-start gap-9">
        <div className=" lg:sticky lg:top-0">
          ...
          <div className="w-full bg-customColor px-7 rounded-xl mt-5 h-[350px]">
            <div className="flex justify-center">
              <img
                src="https://html.awaikenthemes.com/spicyhunt/images/icon-sidebar-cta.svg"
                alt=""
                className="lg:w-[55px] pb-8 pt-4 flex justify-center"
              />
            </div>
            <h1 className="font-bold text-gray-200 text-xl">
              You have different questions?
            </h1>
            <p className="leading-7 text-center text-md text-gray-200 font-semibold mt-4">
              Our team will answer all your <br /> questions. we ensure a quick{" "}
              <br /> response.
            </p>
            <div className="flex justify-center mt-3">
              <button className="text-black hover:text-white bg-white hover:bg-black transition-all duration-300 ease-in-out font-bold rounded-full p-4 flex justify-center items-center gap-2">
                <PiPhoneThin className="font-bold text-xl" /> {chef?.phone}
              </button>
            </div>
          </div>
        </div>
        <div className="lg:w-[68%] w-[100%]">
          ...
          <div className="mt-3">
            <h1 className="text-white leading-5 font-bold lg:text-[45px] md:text-[35px] text-[30px]">
              ABOUT <span className="text-customColor">ME</span>
            </h1>
          </div>
          ...
          <div>
            <div className="mt-12">
              <h1 className="text-white leading-5 font-bold lg:text-[40px] md:text-[35px] text-[30px]">
                CONTACT <span className="text-customColor">ME</span>
              </h1>
            </div>
            <div className="lg:w-full mt-7 text-gray-300 opacity-90 text-lg leading-7">
              <p>{chef?.descp}</p>
